...
# On Render.com the DATA_DIR env var is set to /data (persistent disk).
# When running locally it falls back to the script's own folder.
_BASE_DIR = os.environ.get(
    "DATA_DIR",
    os.path.dirname(os.path.abspath(__file__))
)

_BOT_TOKEN   = os.environ.get("BOT_TOKEN",  "8809855821:AAHaEUQZNbATetvdNSf8WlqPMwZJy7TbO1g")
_OWNER_ID    = int(os.environ.get("OWNER_ID", "7237337181"))
_OPENAI_KEY  = os.environ.get("OPENAI_API_KEY") or None
